...
class VaadinModule extends AbstractModule {
    ...
    protected void configure() {
        final String i18NProviderClassName = getI18NProviderProperty();

        if (i18NProviderClassName != null) {
            try {
                final Class<? extends I18NProvider> i18NProviderClass = (Class<? extends I18NProvider>) Class.forName(i18NProviderClassName);
